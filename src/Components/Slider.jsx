          ...
          <div className="h-full flex justify-between items-center md:flex-row flex-col gap-16">
            ...
            <div className="w-full flex justify-center items-center transform -rotate-45">
              <div className="w-fit grid grid-cols-2 justify-center items-center gap-2">
                <div className="bg-[url('https://images.pexels.com/photos/139751/pexels-photo-139751.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] w-44 h-44 rounded-md bg-cover bg-no-repeat ml-auto"></div>
                <div className="bg-[url('https://images.pexels.com/photos/70497/pexels-photo-70497.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] w-40 h-40 rounded-md bg-cover bg-no-repeat mt-auto"></div>
                <div className="bg-[url('https://images.pexels.com/photos/376464/pexels-photo-376464.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] w-52 h-52 rounded-md bg-cover bg-no-repeat mt-auto"></div>
